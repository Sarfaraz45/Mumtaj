<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="PO_OLD.aspx.cs" Inherits="PROCUREMENT_PO_OLD" %>
 ...
 <div class="row">
			    ...
			    <div class="col-md-12">
                   ...
                   <div class="panel widget light-widget panel-bd-top">
                    ...
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="icon-pie"></i> </span> Manual Purchase! </h3>
    ...
    function SaveTransaction() {
        ...
        if (cc > 0) {
            $.ajax({
                ...
                '", "txtTotAmount" : "' + txtTotAmount + '", "txtDiscount" : "' + txtDiscount + '", "txtTaxRate" : "' + txtTaxRate + '", "txtTotTax" : "' + txtTotTax + '", "txtGrandTotal" : "' + txtGrandTotal + '", "ddlSupplier" : "' + ddlSupplier + '" }',
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                success: function (msg) {
                    tblRows = msg.d;
