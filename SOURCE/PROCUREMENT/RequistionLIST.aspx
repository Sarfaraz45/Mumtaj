<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="RequistionLIST.aspx.cs" Inherits="PROCUREMENT_RequistionLIST" %>
...
<!-- ================== BEGIN PAGE LEVEL STYLE ================== -->
    ...
    <div class="row">
			    ...
			    <div class="col-md-12">
                    ...
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="icon-pie"></i> </span> Requisition List! </h3>
...
<script type="text/javascript">
    ...
    function LoadLIST() {
       ...
       // alert('ddddddddd');
        $.ajax({
            type: 'POST',
            url: 'RequistionLIST.aspx/LoadLIST',
            data: '{ "UserID" : "' + UserID + '" }',
