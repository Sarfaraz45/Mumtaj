...
//        }
    ...
    function LOAD_ITEMS() {
        ...
        $.ajax({
            type: 'POST',
            url: 'WH_Transfer.aspx/LOAD_ITEMS',
            data: '{ "UserID" : "' + UserID + '" }',
    ...
    function SaveTransaction() {
        ...
        if (cc > 0) {
            $.ajax({
                type: 'POST',
                url: 'WH_Transfer.aspx/SaveGoods',
                //data: {},
                data: '{ "UserID" : "' + UserID + '", "str" : "' + str + '", "txtVDate" : "' + txtVDate + '", "txtVoucherNo" : "' + txtVoucherNo + '", "ddlTransferFrom" : "' + ddlTransferFrom + '", "ddlTransferTo" : "' + ddlTransferTo + '", "JOB" : "' + JOB + '"}',
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                success: function (msg) {
                    tblRows = msg.d;
