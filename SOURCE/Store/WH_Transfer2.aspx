<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="WH_Transfer2.aspx.cs" Inherits="Store_WH_Transfer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <asp:HiddenField ID="hdnItems" runat="server" Value='["Karachi","Hyderabad","USA","Arkansas","California","Colorado","Connecticut","Delaware","Florida","Georgia","Hawaii","Idaho","Illinois","Indiana","Iowa","Kansas","Kentucky"]' />
    <asp:HiddenField ID="hdnItemsM" runat="server" Value='["Karachi","Hyderabad","USA","Arkansas","California","Colorado","Connecticut","Delaware","Florida","Georgia","Hawaii","Idaho","Illinois","Indiana","Iowa","Kansas","Kentucky"]' />
 ...
 <div class="row">
			    ...
			    <div class="col-md-12">
                   ...
                   <div class="panel widget light-widget panel-bd-top">
                    ...
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="icon-pie"></i> </span> Production Closing </h3>
                        ...
                        <div class=" panel-body-list" style="padding:10px">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label class="col-md-12 control-label">Closing Date</label>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="col-md-12 control-label">Received In</label>
                         ...
                         <div class="row"><div class="col-lg-12" style="height:10px"></div></div>
                            ...
                            <div class="row">
                                <div class="col-lg-12 table-responsive">
                                    <table id="tblItemsM" class="table table-striped table-bordered dataTable no-footer">
                                        <tr>
                                            <th style="width:5%">S.No.</th>
                                            <th style="width:65%">Material</th>
                                            <th style="width:15%">Used Qty.</th>
                                            <th style="width:15%">Wastage Qty.</th>
                                        </tr>
                                        <tr>
                                            <td><input type="text" id="txtSrM1" value="1" disabled="disabled" class="form-control"  style="width:100%; border:0px none;"/></td>
                                            <td>
                                             
                                             
                                             <input type="text" class="span6 typeahead form-control"  style="border:0px none;" id="txtAccCodeM1"  data-provide="typeahead" style="width:100%" 
                                             data-items="15" autocomplete="off" >
                                            </td>                   
                                            
                                            <td><input type="text" id="txtWtM1" class="form-control" value="1" title="1000" style="width:100%;" autocomplete="off" /></td>
                                              <td><input type="text" id="txtWgM1" class="form-control" value="1" title="1000" style="width:100%;" autocomplete="off" /></td>
                            ...
                            <i class="fa fa-2x fa-plus-square" onclick="addRowM();"></i></div>
...
--%>
    ...
    <script src="WH_Transfer2.js" type="text/javascript"></script>
