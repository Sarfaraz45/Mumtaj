<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/MasterPage.master" AutoEventWireup="true" CodeFile="ISSUE_DC.aspx.cs" Inherits="Store_ISSUE_DC" %>
...
<div class="row"  id="dvOrderList">
			    ...
			    <div class="col-md-12" >
                   ...
                   <div class="panel widget light-widget panel-bd-top">
                    ...
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="icon-pie"></i> </span> Issue Delivery Challan! </h3>
...
<!-- Modal Purchase Order -->
                    ...
                    <div class="modal-dialog" >
                      <div class="modal-content" style="width:900px">
                        <div class="modal-header vd_bg-blue vd_white">
                          ...
                          <h4 class="modal-title" id="H1">Issue Delivery Challan</h4>
                        </div>
                           ...
                           <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                <asp:DropDownList ID="ddlDriver" CssClass="form-control" runat="server" DataSourceID="SqlDataSource1" 
                                            DataTextField="DriverTitle" DataValueField="DriverID">
                                </asp:DropDownList>
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                            ConnectionString="<%$ ConnectionStrings:Con %>" 
                                            SelectCommand="SELECT '0' as [DriverID],'Outside Driver' as [DriverTitle] FROM [DRIVER] union SELECT [DriverID], [DriverTitle] FROM [DRIVER]">
                             ...
                             <div class="col-lg-3" >
                                <div class="form-group">
                                    <label class="col-md-12 control-label">Driver Name</label>
                                    
                                    <div class="col-md-12">
                                <input id="txtDriverName" class="width-100"/>
                            ...
                            <div class="col-lg-3" >
                                <div class="form-group">
                                    <label class="col-md-12 control-label">Vehicle No.</label>
                                    
                                    <div class="col-md-12">
                                <input id="txtVehicleNo" class="width-100"/>
                             ...
                             <div class="col-lg-3" >
                                <div class="form-group">
                                    <label class="col-md-12 control-label">Payment to Driver</label>
                                    
                                    <div class="col-md-12">
                                <input id="txtPaymentDriver" class="width-100" value="0"/>
                            ...
                            <div class="col-lg-3" >
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                <asp:DropDownList ID="ddlWH" CssClass="form-control" runat="server" DataSourceID="SqlDataSource2" 
 ...
 <script src="../js/jquery-1.9.1.min.js"></script>
    ...
    <script src="ISSUE_DC.js" type="text/javascript"></script>
