...
function Approve(id,cycleid) {
    ...
    $.ajax({
        type: 'POST',
        url: 'TaskProcessOps.aspx/Approve',
        //data: {},
...
function SaveVehicle() {
    ...
    $.ajax({
        type: 'POST',
        url: 'TaskProcessOps.aspx/SaveVehicle',
        //data: {},
...
function LoadDriver() {
    $.ajax({
        type: "POST",
        url: "TaskProcessOps.aspx/LoadDriver",
        data: {},
        dataType: "json",
        contentType: "application/json; charset=utf-8",
...
function LoadVehicle() {
    $.ajax({
        type: "POST",
        url: "TaskProcessOps.aspx/LoadVehicle",
        data: {},
        dataType: "json",
        contentType: "application/json; charset=utf-8",
        success: function (data) {
...
function LoadTaskDetail(TaskID) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "TaskProcessOps.aspx/LoadRegionTask",
        dataType: "json",
        //data: "{}",
...
//                ddlvehicle = "<select class='form-control' id='ddlVehicle1'><option value='0'>Select</option>" + ddlvehicle + "</select>";

//                var ddlDriver = document.getElementById("ddlDriver").innerHTML;
//                ddlDriver = "<select class='form-control' id='ddlDriver1'><option value='0'>Select</option>" + ddlDriver + "</select>";
//                ro += "<tr><td   class='one'>" + itmlist[0] + "</td><td   class='two'  style='text-align:center;'>" + itmlist[1] + "</td><td style='text-align:center;'>0</td><td>" + ddlvehicle + "</td><td>" + ddlDriver + "</td><td style='text-align:center;'><button class='btn buttons-selected btn-warning btn-sm mr-1' tabindex='0' aria-controls='dt-basic-example' type='button'  ><span><i class='fal fa-download'></i> Add</span></button></td></tr>";
//            }
//            ro = ro + "</tbody></table>";
...
function LoadVehicleDetail(TaskID) {
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "TaskProcessOps.aspx/LoadVehicleDetail",
        dataType: "json",
        //data: "{}",
        data: '{ "TaskID" : "' + TaskID + '" }', //advAmnt strINV tax1 tax2
        success: function (data) {
...
function LoadRegion() {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "TaskProcessOps.aspx/LoadRegion",
        dataType: "json",
        //data: "{}",
