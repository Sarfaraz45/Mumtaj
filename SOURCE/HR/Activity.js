...
function LoadSaveToastr() {
    Command: toastr["success"]("Task Type has been saved Successfully.")
...
function LoadUpdateToastr() {
    Command: toastr["info"]("Task Type has been updated Successfully.")
...
function LoadDeleteToastr() {
    Command: toastr["error"]("Task Type has been deleted Successfully.")
