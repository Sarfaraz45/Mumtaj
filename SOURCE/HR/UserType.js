...
function LoadSaveToastr() {
    Command: toastr["success"]("User Type has been saved Successfully.")
...
function LoadUpdateToastr() {
    Command: toastr["info"]("User Type has been updated Successfully.")
...
function LoadDeleteToastr() {
    Command: toastr["error"]("User Type has been deleted Successfully.")
...
function InsertData() {
    ...
    var UserID = localStorage.getItem("UserID");
        $.ajax({
            type: 'POST',
            url: 'UserType.aspx/SaveTransaction',
            //data: {},
...
function UpdateData() {
    ...
    $.ajax({
        type: 'POST',
        url: 'UserType.aspx/UpdateTransaction',
        //data: {},
...
function DeleteData(id) {
    ...
    $.ajax({
        type: 'POST',
        url: 'UserType.aspx/DeleteTransaction',
        //data: {},
