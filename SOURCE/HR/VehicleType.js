...
function LoadSaveToastr() {
    Command: toastr["success"]("Vehicle Type has been saved Successfully.")
...
function LoadUpdateToastr() {
    Command: toastr["info"]("Vehicle Type has been updated Successfully.")
...
function LoadDeleteToastr() {
    Command: toastr["error"]("Vehicle Type has been deleted Successfully.")
...
function LoadDetail(id) {
    ...
    $.ajax({
        ...
        url: "VehicleType.aspx/LoadDetail",
        dataType: "json",
        //  data: "{}",
...
function LoadRegion() {
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "VehicleType.aspx/LoadRegion",
        dataType: "json",
        data: "{}",
        success: function (data) {
            var jsdata = JSON.parse(data.d);
            ...
            ro = "<table id='dt-basic-example'class='table table-sm  dataTable dtr-inline table-hover' ><thead class='thead-themed'> <th>Title</th><th>Description</th><th style='text-align:center;'>Action</th></thead><tbody>";
            $.each(jsdata, function (key, value) {
...
function InsertData() {
    ...
    var UserID = localStorage.getItem("UserID");
        $.ajax({
            type: 'POST',
            url: 'VehicleType.aspx/SaveTransaction',
            //data: {},
...
function UpdateData() {
    ...
    $.ajax({
        type: 'POST',
        url: 'VehicleType.aspx/UpdateTransaction',
        //data: {},
...
function DeleteData(id) {
    ...
    $.ajax({
        type: 'POST',
        url: 'VehicleType.aspx/DeleteTransaction',
        //data: {},
