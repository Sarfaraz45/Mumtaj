...
function LoadSaveToastr() { 
    Command: toastr["success"]("Shift has been saved Successfully.")
...
function LoadUpdateToastr() {
    Command: toastr["info"]("Shift has been updated Successfully.")
...
function LoadDeleteToastr() {
    Command: toastr["error"]("Shift has been deleted Successfully.")
...
function LoadDetail(id) {
    ...
    $.ajax({
        ...
        url: "AttendanceList.aspx/LoadDetail",
        dataType: "json",
        //  data: "{}",
...
function LoadRegion() {
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "AttendanceList.aspx/LoadRegion",
        dataType: "json",
        data: "{}",
        success: function (data) {
            var jsdata = JSON.parse(data.d);
...
function InsertData() {
    ...
    var UserID = localStorage.getItem("UserID");
        $.ajax({
            type: 'POST',
            url: 'AttendanceList.aspx/SaveTransaction',
            //data: {},
...
function UpdateData() {
    ...
    $.ajax({
        type: 'POST',
        url: 'AttendanceList.aspx/UpdateTransaction',
        //data: {},
...
function DeleteData(id) {
    ...
    $.ajax({
        type: 'POST',
        url: 'AttendanceList.aspx/DeleteTransaction',
        //data: {},
