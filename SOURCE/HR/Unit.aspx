<%@ Page Title="" Language="C#" MasterPageFile="~/HR/MasterPage.master" AutoEventWireup="true" CodeFile="Unit.aspx.cs" Inherits="HR_Default" %>
    ...
    <main id="js-page-content" role="main" class="page-content">
                        ...
                        <div class="subheader">
                            <h1 class="subheader-title">
                                <i class='subheader-icon fal fa-edit'></i> Form Designation
                            </h1>
                        </div>
                            ...
                            <label>
                              <input type="checkbox" class="js-switch" id="chkbase" Unchecked /> IsBase
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" min=0  class="form-control is-invalid" placeholder="Base Multiplier Name" id="txtbasemulti" autocomplete="off" onkeyup="CheckDataLength();" />
                                                     <div class="valid-feedback">
                                                            Looks good!
                                                        </div>
                                                        <div class="invalid-feedback">
