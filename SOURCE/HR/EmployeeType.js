...
function LoadSaveToastr() {
    Command: toastr["success"]("Employee Type has been saved Successfully.")
...
function LoadUpdateToastr() {
    Command: toastr["info"]("Employee Type has been updated Successfully.")
...
function LoadDeleteToastr() {
    Command: toastr["error"]("Employee Type has been deleted Successfully.")
...
function LoadDetail(id) {
    ...
    $.ajax({
        ...
        url: "EmployeeType.aspx/LoadDetail",
        dataType: "json",
        //  data: "{}",
...
function LoadRegion() {
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "EmployeeType.aspx/LoadRegion",
        dataType: "json",
        data: "{}",
        success: function (data) {
            var jsdata = JSON.parse(data.d);
...
function InsertData() {
    ...
    var UserID = localStorage.getItem("UserID");
        $.ajax({
            type: 'POST',
            url: 'EmployeeType.aspx/SaveTransaction',
            //data: {},
...
function UpdateData() {
    ...
    $.ajax({
        type: 'POST',
        url: 'EmployeeType.aspx/UpdateTransaction',
        //data: {},
...
function DeleteData(id) {
    ...
    $.ajax({
        type: 'POST',
        url: 'EmployeeType.aspx/DeleteTransaction',
        //data: {},
