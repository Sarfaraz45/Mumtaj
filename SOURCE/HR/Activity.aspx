...
<%--<script src="../js/vendors.bundle.js" type="text/javascript"></script>
   ...
   <title>WasteEnable | Task Type</title>
    ...
    <main id="js-page-content" role="main" class="page-content">
                        ...
                        <div class="subheader">
                            <h1 class="subheader-title">
                                <i class='subheader-icon fal fa-edit'></i> Add Task Type
                            </h1>
                        </div>
                                        ...
                                        <div class="panel-content">      
                                            ...
                                            <form>
                                                ...
                                                <div class="form-group">
                                                    <label class="form-label" for="example-palaceholder">Task Type Title</label>
                                                    <input type="text" class="form-control is-invalid" placeholder="Type Task Type Title" id="txtTitle" autocomplete="off" onkeyup="CheckDataLength();" >
