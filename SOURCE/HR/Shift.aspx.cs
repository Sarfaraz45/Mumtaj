...
public partial class HR_Default : System.Web.UI.Page
{
    ...
    public static string LoadRegion()
    {
        ...
        SqlDataAdapter da = new SqlDataAdapter("SELECT * from Shift where IsDelete=0 order by 1", Conn);
    ...
    public static string LoadDetail(string id)
    {
        ...
        SqlDataAdapter da = new SqlDataAdapter("SELECT     * from Shift where IsDelete=0 and ShiftID='" + id + "' order by 1", Conn);
        DataTable dt = new DataTable();
        da.Fill(dt);
    ...
    public static string SaveTransaction(string Title,  string UserID)
    {
        ...
        string a = AACommon.GetAlphaNumericIDSIX("Shift", "Shf-", "ShiftID", Con);
        SqlCommand cmd = new SqlCommand("insert into Shift ( ShiftID,ShiftTitle,CREATEBY) values ('" + a + "',  '" + Title + "' ,'" + UserID + "')", Con);
        Con.Open();
        cmd.ExecuteNonQuery();
        Con.Close();
    ...
    public static string UpdateTransaction(string Title,   string id, string UserID)
    {
        ...
        SqlCommand cmd = new SqlCommand("update Shift  set  ShiftTitle='" + Title + "'  where ShiftID='" + id + "'", Con);
        Con.Open();
        cmd.ExecuteNonQuery();
        Con.Close();
    ...
    public static string DeleteTransaction(string id, string UserID)
    {
        ...
        SqlCommand cmd = new SqlCommand("update Shift  set IsDelete=1,DELETEBY='" + UserID + "',DELETEDATE='" + DateTime.Now + "' where ShiftID='" + id + "'", Con);
        Con.Open();
        cmd.ExecuteNonQuery();
        Con.Close();
