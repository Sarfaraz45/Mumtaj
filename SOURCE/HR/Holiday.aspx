<%@ Page Title="" Language="C#" MasterPageFile="~/HR/MasterPage.master" AutoEventWireup="true" CodeFile="Holiday.aspx.cs" Inherits="HR_Default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
   ...
   <title>WasteEnable | Holiday</title>
</asp:Content>
    ...
    <main id="js-page-content" role="main" class="page-content">
                        ...
                        <div class="subheader">
                            <h1 class="subheader-title">
                                <i class='subheader-icon fal fa-edit'></i> Add Holiday
                            </h1>
                        </div>
                                        ...
                                        <div class="panel-content">      
                                            ...
                                            <form>
                                                ...
                                                <div class="form-group">
                                                    <label class="form-label" for="example-palaceholder">Holiday Title</label>
                                                    <input type="text" class="form-control is-invalid" placeholder="Type Leave Title" id="txtTitle" autocomplete="off" onkeyup="CheckDataLength();" >
                                                     <div class="valid-feedback">
                                                          ...
                                                          Please provide a valid Holiday Title.
                                                        </div>
                                                </div>
                                                </div>  
                                                   <div class="col-md-6">
