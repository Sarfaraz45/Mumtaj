...
function LoadVehicleType() {
    ...
    $.ajax({
        type: 'POST',
        url: 'Complain.aspx/LoadVehicleType',
        data: {},                
        contentType: 'application/json; charset=utf-8',
        dataType: 'json',
        success: function (msg) {
...
//    var ToDate = document.getElementById('ToDate').value;
    ...
    if (dta != "") {
        ...
        $.ajax({
            type: 'POST',
            url: 'Complain.aspx/SaveTransaction',
            //data: {},
