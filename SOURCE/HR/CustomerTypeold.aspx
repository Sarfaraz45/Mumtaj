<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/MasterPage.master" AutoEventWireup="true" CodeFile="CustomerTypeold.aspx.cs" Inherits="ERP_CustomerType" %>
    ...
    <script type="text/javascript">
      $(document).ready(function () {
        ...
        function Save() {
            ...
            if (field == "" || field == null) {
                document.getElementById("txtCustomerType").style.border = "solid 1px red";
                return false;
            }
        ...
        function SaveData() {
            ...
            document.getElementById("txtCustomerType").style.border = "solid 1px white";
        ...
        function UpdateRegion() {
            ...
            var dataToSend = JSON.stringify({ 'CustomerTypeID': $('#ContentPlaceHolder1_hdnid').val(), 'CustomerTypeDesc': $('#txtCustomerType').val() });
            //alert(dataToSend);
            var results = $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
        ...
        function DeleteRegion() {
            //  alert($('#ContentPlaceHolder1_hdnid').val());
            var UserID = localStorage.getItem("UserID");
            var dataToSend = JSON.stringify({ 'CustomerTypeID': $('#ContentPlaceHolder1_hdnid').val(), 'UserID': UserID });
            var results = $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                ...
                <div class="panel widget">
                  ...
                  <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Customer Type<span class="required"> *</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="txtCustomerType" required="required" class="form-control col-md-7 col-xs-12" placeholder="Enter Customer Type">  
