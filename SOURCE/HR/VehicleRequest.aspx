<%@ Page Title="" Language="C#" MasterPageFile="~/HR/MasterPage.master" AutoEventWireup="true" CodeFile="VehicleRequest.aspx.cs" Inherits="HR_Default" %>
...
<%--
   <link href="https://cdn.datatables.net/1.10.21/css/jquery.dataTables.min.css" rel="stylesheet">
    ...
    <title>WasteEnable | Vehicle Request</title>
</asp:Content>
...
<asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
    <main id="js-page-content" role="main" class="page-content">
                        ...
                        <div class="subheader">
                            <h1 class="subheader-title">
                                <i class='subheader-icon fal fa-edit'></i> Vehicle Request List
                            </h1>
                        </div>
                     
                        
     <label id="lbltemp" style="display:none;"></label>
                       <label id="lbltaskid" style="display:none;"></label>
                       <label id="lblCycleID" style="display:none;"></label>
                          ...
                          <div class="row">
                            <div class="col-xl-12">
                                <div id="Div1" class="panel">
                                    <div class="panel-hdr">
                                        <h2>
                                            Pending Vehicle Requisition List
                                        </h2>
    ...
    <div class="modal fade" id="default-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
                                                <div class="modal-dialog modal-lg" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title">VEHICLE REQUEST DETAIL</h5>
          ...
          <script src="VehicleRequest.js" type="text/javascript"></script>
