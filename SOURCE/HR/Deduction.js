...
function LoadSaveToastr() {
    Command: toastr["success"]("Deduction has been saved Successfully.")
...
function LoadUpdateToastr() {
    Command: toastr["info"]("Deduction has been updated Successfully.")
...
function LoadDeleteToastr() {
    Command: toastr["error"]("Deduction has been deleted Successfully.")
...
function InsertData() {
    ...
    var UserID = localStorage.getItem("UserID");
        $.ajax({
            type: 'POST',
            url: 'Deduction.aspx/SaveTransaction',
            //data: {},
...
function UpdateData() {
    ...
    $.ajax({
        type: 'POST',
        url: 'Deduction.aspx/UpdateTransaction',
        //data: {},
...
function DeleteData(id) {
    ...
    $.ajax({
        type: 'POST',
        url: 'Deduction.aspx/DeleteTransaction',
        //data: {},
