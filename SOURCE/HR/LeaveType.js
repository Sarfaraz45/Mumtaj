...
function LoadSaveToastr() {
    Command: toastr["success"]("Leave Type has been saved Successfully.")
...
function LoadUpdateToastr() {
    Command: toastr["info"]("Leave Type has been updated Successfully.")
...
function LoadDeleteToastr() {
    Command: toastr["error"]("Leave Type has been deleted Successfully.")
...
function InsertData() {
    ...
    var UserID = localStorage.getItem("UserID");
        $.ajax({
            type: 'POST',
            url: 'LeaveType.aspx/SaveTransaction',
            //data: {},
...
function UpdateData() {
    ...
    $.ajax({
        type: 'POST',
        url: 'LeaveType.aspx/UpdateTransaction',
        //data: {},
...
function DeleteData(id) {
    ...
    $.ajax({
        type: 'POST',
        url: 'LeaveType.aspx/DeleteTransaction',
        //data: {},
