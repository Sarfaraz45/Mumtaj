<%@ Page Title="" Language="C#" MasterPageFile="~/HR/MasterPage.master" AutoEventWireup="true" CodeFile="StationType.aspx.cs" Inherits="HR_Default" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
    <main id="js-page-content" role="main" class="page-content">
                        ...
                        <div class="subheader">
                            <h1 class="subheader-title">
                                <i class='subheader-icon fal fa-edit'></i> Add Station Type
                            </h1>
                        </div>
                                        ...
                                        <div class="panel-content">      
                                            ...
                                            <form>
                                                ...
                                                <div class="form-group">
                                                    <label class="form-label" for="example-palaceholder">Station Type Title</label>
                                                    <input type="text" class="form-control" placeholder="Type Station Type Title" id="txtTitle" autocomplete="off">
                                                </div>
                                                </div>
    ...
    <script src="StationType.js" type="text/javascript"></script> 
