<%@ Page Title="" Language="C#" MasterPageFile="~/HR/MasterPage.master" AutoEventWireup="true" CodeFile="TaskProcess.aspx.cs" Inherits="HR_Default" %>
...
<%--
   <link href="https://cdn.datatables.net/1.10.21/css/jquery.dataTables.min.css" rel="stylesheet">
    ...
    <title>WasteEnable | Task Approval Board</title>
</asp:Content>
    ...
    <div class="modal fade" id="default-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
                                    ...
                                    <div class="panel-container show">
                                        <div class="panel-content">      
                                            ...
                                            <form>
                                                ...
                                                <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="form-label" for="example-select">Task Activity</label>
                                               ...
                                               <div class="row">
                                                 ...
                                                 <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="date" value="2023-07-23T11:25:00" id="txtStartDate">
                                                    </div>
                                                   </div>
                                                  <div class="col-md-6" style="display:none;">  
                                                    <div class="form-group">
                                                    <label class="form-label" for="EndDate">End Date</label>
                                                    <input class="form-control" type="date" value="2023-07-23T11:25:00" id="txtEndDate">
                                                    </div>
                                             </div>
                                               <div class="col-md-6">
                                                <div class="form-group">
                           ...
                           <div class="panel-hdr" style="min-height:0px;">
                                    ...
                                    <div class="row" style="height:20px;"></div>
                                             ...
                                             <button type="button" class="btn btn-success waves-effect waves-themed" onclick="SaveTransaction();">Update</button>
                                             ...
                                             <button type="button" class="btn btn-warning waves-effect waves-themed">Cancel</button>--%>
                                                ...
                                                <div class="form-group">
                                                 ...
                                                 <%-- <div class="row" style="height:20px;"></div>
                                                  ...
                                                  <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="form-label" for="example-palaceholder">Start Date</label>
          ...
          <script src="TaskProcess.js" type="text/javascript"></script>
