...
public partial class HR_Default : System.Web.UI.Page
{
    ...
    public static string LoadRegion()
    {
        ...
        SqlDataAdapter da = new SqlDataAdapter("SELECT * from USERTYPE where IsDelete=0 order by 1", Conn);
    ...
    public static string LoadDetail(string id)
    {
        ...
        SqlDataAdapter da = new SqlDataAdapter("SELECT     * from USERTYPE where IsDelete=0 and UTID='" + id + "' order by 1", Conn);
        DataTable dt = new DataTable();
        da.Fill(dt);
    ...
    public static string SaveTransaction(string Title,  string UserID)
    {
        ...
        SqlCommand cmd = new SqlCommand("insert into USERTYPE (UTDesc,CREATEBY) values ('" + Title + "' ,'" + UserID + "')", Con);
        Con.Open();
        cmd.ExecuteNonQuery();
        Con.Close();
    ...
    public static string UpdateTransaction(string Title,   string id, string UserID)
    {
        ...
        SqlCommand cmd = new SqlCommand("update USERTYPE  set  UTDesc='" + Title + "'  where UTID='" + id + "'", Con);
        Con.Open();
        cmd.ExecuteNonQuery();
        Con.Close();
    ...
    public static string DeleteTransaction(string id, string UserID)
    {
        ...
        SqlCommand cmd = new SqlCommand("update USERTYPE  set IsDelete=1,MODIFYBY='" + UserID + "',MODIFYDATE='" + DateTime.Now + "' where UTID='" + id + "'", Con);
        Con.Open();
        cmd.ExecuteNonQuery();
        Con.Close();
