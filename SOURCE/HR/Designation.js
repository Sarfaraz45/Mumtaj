...
function LoadSaveToastr() {
    Command: toastr["success"]("Designation has been saved Successfully.")
...
function LoadUpdateToastr() {
    Command: toastr["info"]("Designation has been updated Successfully.")
...
function LoadDeleteToastr() {
    Command: toastr["error"]("Designation has been deleted Successfully.")
...
function LoadDetail(id) {
    ...
    $.ajax({
        ...
        url: "Designation.aspx/LoadDetail",
        dataType: "json",
        //  data: "{}",
...
function LoadRegion() {
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "Designation.aspx/LoadRegion",
        dataType: "json",
        data: "{}",
        success: function (data) {
            var jsdata = JSON.parse(data.d);
...
function InsertData() {
    ...
    var UserID = localStorage.getItem("UserID");
        $.ajax({
            type: 'POST',
            url: 'Designation.aspx/SaveTransaction',
            //data: {},
...
function UpdateData() {
    ...
    $.ajax({
        type: 'POST',
        url: 'Designation.aspx/UpdateTransaction',
        //data: {},
...
function DeleteData(id) {
    ...
    $.ajax({
        type: 'POST',
        url: 'Designation.aspx/DeleteTransaction',
        //data: {},
