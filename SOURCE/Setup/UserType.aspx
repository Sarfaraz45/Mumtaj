<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/MasterPage.master" AutoEventWireup="true" CodeFile="UserType.aspx.cs" Inherits="Setup_UserType" %>
...
border-color: #d8dde1;
    ...
    <script type="text/javascript">
        ...
        function InsertRegion() {
            ...
            var dataToSend = JSON.stringify({ 'RegionName': $('#txtRegionName').val(), 'UserID': UserID });
            var results = $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
        ...
        function UpdateRegion() {
            var UserID = localStorage.getItem("UserID");
            var dataToSend = JSON.stringify({ 'RegionID': $('#ContentPlaceHolder1_hdnid').val(), 'RegionName': $('#txtRegionName').val(), 'UserID': UserID });
            alert(dataToSend);
            var results = $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
        ...
        function DeleteRegion() {
            var UserID = localStorage.getItem("UserID");
            var dataToSend = JSON.stringify({ 'RegionID': $('#ContentPlaceHolder1_hdnid').val(), 'UserID': UserID });
            var results = $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
...
<div class="modal fade" id="modal-dialog">
    ...
    <asp:HiddenField ID="hdntitle" runat="server" />
              ...
              <div class="col-md-6">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> User Type List </h3>
                  </div>
