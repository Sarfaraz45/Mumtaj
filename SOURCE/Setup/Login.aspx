<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Login.aspx.cs" Inherits="Setup_Login" %>
    ...
    <![endif]-->
     ...
     <script type="text/javascript">
         function ProcessLogin() {
             var dataToSend = JSON.stringify({ 'LoginID': $('#username').val(), 'password': $('#password').val() });
            // alert(dataToSend);
          ...
          <div class="vd_content-section clearfix">
            <div class="vd_login-page">
              <div class="heading clearfix">
                <div class="logo">
                  <h2 class="mgbt-xs-5"><img src="../AAUI/img/logo.png" alt="logo"></h2>
                </div>
                    ...
                    <div class="form-group  mgbt-xs-20">
                      <div class="col-md-12">
                        ...
                        <div class="vd_input-wrapper" id="email-input-wrapper"> <span class="menu-icon"> <i class="fa fa-envelope"></i> </span>
                          <input type="text" placeholder="Email" id="username" name="email" class="required" required>
                        </div>
...
<%--                        <button class="btn vd_bg-green vd_white width-100" type="submit" id="login-submit" onclick="ProcessLogin();>Login</button>--%>
                         <input class="btn vd_bg-green vd_white width-100"  id="Button1"  type="button" value="Sign In"  onclick="ProcessLogin()" />
...
<script type="text/javascript" src="js/../AAUI/plugins.js"></script>
