...
function LoadRegion() {
    $.ajax({
        ...
        success: function (data) {
            ...
            ro = "<table id='tablepaging' class='table table-sm dataTable dtr-inline table-hover'  style='cursor: pointer; border:1px solid #F3F4F6; border-radius: 8px;'><thead  ><th style='font-weight:900;background-color:#F3F4F6;'>ID</th> <th style='font-weight:900; background-color:#F3F4F6;'>Customer</th> <th style='font-weight:900; background-color:#F3F4F6;'>Phone</th>  </thead><tbody>";
            $.each(jsdata, function (key, value) {
